...
export const MENU_ITEMS: MenuItem[] = [
  // ─── SEAFOOD ───────────────────────────────────────────────────────
  {
    ...
    badge: 'Chef',
    translations: {
      en: { name: 'Grilled Fish', description: 'Freshly caught daily, grilled with lemon herb butter and seasonal vegetables' },
      ar: { name: 'السمك المشوي', description: 'طازج يومياً، مشوي بزبدة الليمون والأعشاب مع الخضار الموسمية' },
      ru: { name: 'Рыба на гриле', description: 'Свежевыловленная ежедневно, на гриле с лимонным маслом и сезонными овощами' },
      fr: { name: 'Poisson grillé', description: 'Pêche fraîche du jour, grillé au beurre citron-herbes avec légumes de saison' },
      de: { name: 'Gegrillter Fisch', description: 'Täglich frisch gefangen, gegrillt mit Zitronen-Kräuterbutter und Saisongemüse' },
      it: { name: 'Pesce grigliato', description: 'Pescato fresco ogni giorno, grigliato con burro al limone ed erbe e verdure di stagione' },
      es: { name: 'Pescado a la plancha', description: 'Captura fresca del día, a la plancha con mantequilla de limón y hierbas y verduras de temporada' },
      zh: { name: '碳烤鱼', description: '每日新鲜捕捞，配柠檬香草黄油与时令蔬菜炭烤' },
      ja: { name: 'グリルフィッシュ', description: '毎日水揚げされた新鮮な魚をレモンハーブバターで香ばしくグリル、季節野菜添え' },
      pt: { name: 'Peixe grelhado', description: 'Capturado fresco diariamente, grelhado com manteiga de ervas e limão e legumes da época' },
      tr: { name: 'Izgara Balık', description: 'Her gün taze yakalanmış, limonlu ve otlu tereyağıyla ızgara ve mevsim sebzeleri ile' },
      ko: { name: '그릴 생선', description: '매일 신선하게 잡은 생선을 레몬 허브 버터로 구워 제철 채소와 함께 제공' },
    },
  },
  {
    id: 'sf-2',
    ...
    descriptionEn: 'Lobster, king prawns, scallops, and oysters on crushed ice',
    price: 89.0,
    image: '/images/seafood-platter.png',
    badge: 'Popular',
    translations: {
      en: { name: 'Royal Seafood Platter', description: 'Lobster, king prawns, scallops, and oysters on crushed ice' },
      ar: { name: 'طبق المأكولات البحرية الملكي', description: 'جراد البحر وروبيان الملك والإسكالوب والمحار على الثلج المجروش' },
      ru: { name: 'Королевское ассорти морепродуктов', description: 'Лобстер, королевские креветки, морские гребешки и устрицы на колотом льду' },
      fr: { name: 'Plateau royal de fruits de mer', description: 'Homard, crevettes royales, noix de Saint-Jacques et huîtres sur glace pilée' },
      de: { name: 'Königliche Meeresfrüchteplatte', description: 'Hummer, Riesengarnelen, Jakobsmuscheln und Austern auf gestoßenem Eis' },
      it: { name: 'Piatto reale di frutti di mare', description: 'Aragosta, gamberi reali, capesante e ostriche su ghiaccio tritato' },
      es: { name: 'Bandeja real de mariscos', description: 'Langosta, gambas reales, vieiras y ostras sobre hielo triturado' },
      zh: { name: '皇家海鲜拼盘', description: '龙虾、大虾、扇贝与生蚝，铺于碎冰之上' },
      ja: { name: 'ロイヤルシーフードプラッター', description: 'ロブスター、有頭エビ、ホタテ、牡蠣を砕氷の上に盛り付け' },
      pt: { name: 'Bandeja real de frutos do mar', description: 'Lagosta, camarão rei, vieiras e ostras sobre gelo triturado' },
      tr: { name: 'Kraliyet Deniz Ürünleri Tabağı', description: 'Istakoz, karides, tarak ve istiridye; kırık buz üzerinde servis edilir' },
      ko: { name: '로얄 해산물 플래터', description: '랍스터, 킹 새우, 가리비, 굴을 얼음 위에 담아 제공' },
    },
  },
  {
    id: 'sf-3',
    ...
    descriptionEn: 'Golden-fried calamari rings with house aioli and fresh lemon',
    price: 24.0,
    image: '/images/calamari.png',
    translations: {
      en: { name: 'Crispy Calamari', description: 'Golden-fried calamari rings with house aioli and fresh lemon' },
      ar: { name: 'كالاماري مقرمش', description: 'حلقات الحبار المقلية ذهبياً مع صوص الأيولي وعصير الليمون الطازج' },
      ru: { name: 'Хрустящие кальмары', description: 'Золотистые кольца кальмара с домашним айоли и свежим лимоном' },
      fr: { name: 'Calamars croustillants', description: "Anneaux de calamars frits dorés, avec aïoli maison et citron frais" },
      de: { name: 'Knusprige Calamari', description: 'Goldgebackene Calamari-Ringe mit Haus-Aioli und frischer Zitrone' },
      it: { name: 'Calamari croccanti', description: 'Anelli di calamari fritti dorati con aioli della casa e limone fresco' },
      es: { name: 'Calamares crujientes', description: 'Anillos de calamar fritos dorados con alioli casero y limón fresco' },
      zh: { name: '香脆鱿鱼圈', description: '鱿鱼圈炸至金黄，搭配自制蒜泥蛋黄酱与鲜柠檬' },
      ja: { name: 'クリスピーカラマリ', description: 'イカリングを黄金色に揚げ、自家製アイオリと新鮮なレモン添え' },
      pt: { name: 'Calamares crocantes', description: 'Anéis de lula fritos dourados com aioli da casa e limão fresco' },
      tr: { name: 'Çıtır Kalamar', description: 'Altın kızartılmış kalamar halkaları, ev yapımı aioli ve taze limon ile' },
      ko: { name: '바삭한 칼라마리', description: '황금빛으로 튀긴 오징어 링에 홈메이드 아이올리와 신선한 레몬 곁들임' },
    },
  },
  ...
  // ─── TRADITIONAL FAVORITES ──────────────────────────────────────────────────
  {
    ...
    descriptionEn: "A beloved traditional dish — rice, lentils, pasta, crispy onions and spiced tomato",
    price: 18.0,
    image: '/images/koshari.png',
    badge: 'Vegan',
    translations: {
      en: { name: 'Koshari Royal', description: "A beloved traditional dish — rice, lentils, pasta, crispy onions and spiced tomato" },
      ar: { name: 'كشري ملكي', description: 'طبق تقليدي محبوب — أرز وعدس ومكرونة وبصل مقرمش وصوص طماطم متبّل' },
      ru: { name: 'Кушари Роял', description: 'Любимое традиционное блюдо — рис, чечевица, паста, хрустящий лук и острый томатный соус' },
      fr: { name: 'Koshari Royal', description: "Un plat traditionnel bien-aimé — riz, lentilles, pâtes, oignons croustillants et sauce tomate épicée" },
      de: { name: 'Koshari Royal', description: "Ein beliebtes traditionelles Gericht — Reis, Linsen, Pasta, knusprige Zwiebeln und gewürzte Tomatensoße" },
      it: { name: 'Koshari Reale', description: "Un amato piatto tradizionale — riso, lenticchie, pasta, cipolle croccanti e pomodoro speziato" },
      es: { name: 'Koshari Real', description: "Un querido plato tradicional — arroz, lentejas, pasta, cebolla crujiente y tomate especiado" },
      zh: { name: '皇家科沙里', description: '深受喜爱的传统菜——米饭、扁豆、意面、炸洋葱与香料番茄酱' },
      ja: { name: 'コシャリ・ロイヤル', description: '愛される伝統料理 — ライス、レンズ豆、パスタ、クリスピーオニオンにスパイシートマトソース' },
      pt: { name: 'Koshari Real', description: "Um amado prato tradicional — arroz, lentilhas, massa, cebola crocante e tomate temperado" },
      tr: { name: 'Koshari Royal', description: "Sevilen geleneksel bir yemek — pilav, mercimek, makarna, çıtır soğan ve baharatlı domates sosu" },
      ko: { name: '코샤리 로얄', description: '사랑받는 전통 음식 — 쌀, 렌틸콩, 파스타, 바삭한 양파, 향신료 토마토 소스' },
    },
  },
  {
    id: 'eg-2',
  ...
  // ─── EXOTIC COCKTAILS ──────────────────────────────────────────────────────
  {
    ...
    badge: 'Popular',
    translations: {
      en: { name: 'Blue Lagoon', description: 'Blue curaçao, tropical vodka, fresh lemon, and sparkling water' },
      ar: { name: 'البحيرة الزرقاء', description: 'كوراساو أزرق وفودكا استوائية وليمون طازج وماء فوار' },
      ru: { name: 'Голубая лагуна', description: 'Голубой кюрасао, тропическая водка, свежий лимон и газированная вода' },
      fr: { name: 'Lagon bleu', description: 'Curaçao bleu, vodka tropicale, citron frais et eau pétillante' },
      de: { name: 'Blaue Lagune', description: 'Blauer Curaçao, Tropische Vodka, frische Zitrone und Sprudelwasser' },
      it: { name: 'Laguna blu', description: 'Curaçao blu, vodka tropicale, limone fresco e acqua frizzante' },
      es: { name: 'Laguna azul', description: 'Curaçao azul, vodka tropical, limón fresco y agua con gas' },
      zh: { name: '蓝礁湖', description: '蓝橙皮酒、热带伏特加、鲜柠檬与苏打水' },
      ja: { name: 'ブルーラグーン', description: 'ブルーキュラソー、トロピカルウォッカ、フレッシュレモン、スパークリングウォーター' },
      pt: { name: 'Lagoa Azul', description: 'Curaçao azul, vodka tropical, limão fresco e água com gás' },
      tr: { name: 'Mavi Lagün', description: 'Mavi curaçao, tropikal votka, taze limon ve maden suyu' },
      ko: { name: '블루 라군', description: '블루 큐라소, 트로피컬 보드카, 신선한 레몬, 탄산수' },
    },
  },
  {
    id: 'ck-2',
